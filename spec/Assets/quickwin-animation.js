...
const quickWinGroups = [
  { // 1 — Hook bubble
    parts: [
      { type: 'richbody', html: 'We ran your AI Search Visibility Check. Here\'s what we found: <strong>AI knows Reunited as a celebrity brand launchpad. It has no idea you\'re one of New York\'s most experienced private label manufacturers for major retailers.</strong> That\'s <strong>half your business invisible</strong> to every retail buyer, brand manager, and sourcing director using AI to find partners today.' },
    ]
  },
  { // 2 — Full report
    parts: [
      { type: 'header', text: 'AI Search Visibility Check — Reunited Clothing' },
      { type: 'body', text: 'We tested the questions a retail buyer, brand manager, or talent representative would actually ask AI — across ChatGPT, Gemini, and Perplexity:' },
      ...
      { type: 'richbody', html: 'The results are a split picture — and <strong>the split itself is the problem.</strong> For the celebrity query, Reunited shows up. Gemini names you twice, citing Royalty by Maluma and Nina Parker. Perplexity surfaces you via a Fashionista article. For the private label and turnkey queries, <strong>you don\'t appear.</strong> AI surfaces Apparel Production Inc., Zega Apparel, The Evans Group. Reunited is absent.' },
      { type: 'richbody', html: 'Every mention that does exist traces back to <strong>a single Fashionista article</strong> — not your website. A journalist described your business more clearly than your site does. <strong>AI knows the celebrity story. It has no idea about the rest.</strong>' },
      { type: 'header', text: 'Why AI only knows half of you' },
      { type: 'richbody', html: 'Your homepage is nearly invisible to AI — almost entirely images, with no client names, no proof points, no category phrases AI can parse. The site never says "private label apparel manufacturer for major department stores" or "turnkey design-to-delivery partner for retail-exclusive fashion lines." Without that language, Reunited doesn\'t exist in AI\'s map of the private label industry. The proof is there — it\'s just hidden behind aspirational language. The about page says "comprehensive solution" and "white space opportunities." It never says "Launched Royalty by Maluma exclusively at Macy\'s" or "Won Revolve\'s Influencer Collaboration of the Year with Olivia Culpo."' },
      { type: 'richbody', html: 'Meanwhile, competitors are naming names. Celebrity Fashion Group lists Cristiano Ronaldo, Selena Gomez, and the Kardashians. LA Collective names Morgan Stewart and Alexis Ren. Reunited\'s site says "collaborations" and shows images. AI recommends whoever provides context — not whoever has better work. And right now, <strong>a single Fashionista article is carrying your entire visibility load. That\'s not a stable position.</strong>' },
      { type: 'header', text: 'What to fix' },
      { type: 'richbody', html: '<ol class="qw-numlist"><li><strong>State the full category in text AI can read.</strong> "Reunited Clothing is a New York-based design house and apparel manufacturer that builds and launches private label and celebrity brands for major retailers including Macy\'s." That sentence doesn\'t exist on your site. It should — on the homepage, in HTML text, not embedded in an image.</li><li><strong>Name the work.</strong> "Royalty by Maluma — launched exclusively at Macy\'s, 2022. Nina Parker — launched exclusively at Macy\'s, 2021. Marled by Olivia Culpo — Revolve Award, Influencer Collaboration of the Year." <strong>Specifics are classification signals. Aspirational language is not.</strong></li><li><strong>Make capabilities structurally discoverable.</strong> Each capability — design, sourcing, manufacturing, logistics — needs to be a distinct, indexable section connected to proof. "Full design-to-delivery operation: in-house design, global sourcing, quality control, and logistics management — currently serving 30+ retail accounts."</li><li><strong>Close the competitor gap.</strong> Your work is stronger than what AI is recommending. "Reunited Clothing has designed, manufactured, and launched brands with Maluma, Nina Parker, Olivia Culpo, and 30+ additional partners across Macy\'s, Revolve, and other major retailers." <strong>The site needs to say exactly that.</strong></li></ol>' },
      { type: 'header', text: 'The bottom line' },
      { type: 'body', text: 'The work is exceptional. The site is only telling part of the story — and that part is being carried by a single article you didn\'t write. Want to see exactly how AI systems classify you across 15–20 queries, where your competitors are winning, and a ranked action plan to close the gap? That\'s the AI-Search Deep Dive.' },
      { type: 'cta' },
...
function deliverQuickWin(chatArea) {
  ...
  setTimeout(() => {
    ...
    microTextEl.style.fontWeight = '900';
    microTextEl.style.color = '#1B2A4A';
    ...
    requestAnimationFrame(() => requestAnimationFrame(() => {
      ...
      microTextEl.textContent = "Here's the full breakdown.";
